...
export default function App() {
  ...
  function handleDeleteWatched(id) {
    setWatched((currentWatchedMovies) =>
      currentWatchedMovies.filter((movie) => movie.imdbID !== id)
    );
  }
  ...
  useEffect(
    function () {
      ...
      return function () {
        ...
        // console.log(`Clean up effect for movie ${title}. Functions will always
        //  remember all the variables that were present at the time & place data
        // fn was created`);
      };
    },
    [title]
